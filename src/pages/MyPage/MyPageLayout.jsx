...
export default function MyPageLayout() {
  ...
  return (
    <div className="min-h-screen">
      {/* ================= 모바일 헤더 ================= */}
      <header className="lg:hidden fixed top-[72px] left-0 right-0 h-14 px-4 border-b bg-white z-40 flex items-center">
      ...
      <div className="flex">
        {/* 데스크톱 사이드바 */}
        <aside className="hidden lg:block w-50 fixed left-0 top-0 h-full">
          <MyPageSidebar />
        </aside>
        ...
        {isOpen && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            />
            <aside className="absolute left-0 top-0 w-50 h-full bg-white shadow-lg">
        ...
        {/* 메인 영역 */}
        <main className="  flex-1 lg:ml-[230px] px-6 lg:px-10 py-8 pt-14 lg:pt-8 ">
          {/* <main className="flex-1 lg:ml-[230px] px-6 lg:px-10 py-8"> */}
